...
ggplot(data = d_01_ccif %>% 
    ...
    scale_x_date(
        date_labels = "%b %y",
        breaks = seq.Date(from = floor_date(as.Date("2015-01-01")+(((month(max(d_01_ccif$date))-1))+31), "month"), 
...
ggplot(data = d_02_01_pan_cereales %>% 
    ...
    scale_x_date(
        date_labels = "%b %y",
        breaks = seq.Date(from = floor_date(as.Date("2015-01-01")+(((month(max(d_02_01_pan_cereales$date))))+31), "month"), 
...
ggplot(data = d_02_02_carnes %>% 
    ...
    scale_x_date(
        date_labels = "%b %y",
        breaks = seq.Date(from = floor_date(as.Date("2015-01-01")+(((month(max(d_02_02_carnes$date))))+31), "month"), 
...
g <- 
    ...
    scale_x_date(
        date_labels = "%b %y",
        breaks = seq.Date(from = floor_date(as.Date("2015-01-01")+(((month(max(d_02_03_lácteos$date))))+31), "month"), 
...
g <- 
    ...
    scale_x_date(
        date_labels = "%b %y",
        breaks = seq.Date(from = floor_date(as.Date("2015-01-01")+(((month(max(d_02_04_frutas$date))))+31), "month"), 
...
g <- 
    ...
    scale_x_date(
        date_labels = "%b %y",
        breaks = seq.Date(from = floor_date(as.Date("2015-01-01")+(((month(max(d_02_05_legum$date))))+31), "month"), 
...
g <- 
    ...
    scale_x_date(
        date_labels = "%b %y",
        breaks = seq.Date(from = floor_date(as.Date("2015-01-01")+(((month(max(d_02_06_aceites$date))))+31), "month"), 
...
g <- 
    ...
    scale_x_date(
        date_labels = "%b %y",
        breaks = seq.Date(from = floor_date(as.Date("2015-01-01")+(((month(max(d_02_07_azucares$date))))+31), "month"), 
...
g <- 
    ...
    scale_x_date(
        date_labels = "%b %y",
        breaks = seq.Date(from = floor_date(as.Date("2015-01-01")+(((month(max(d_03_bebidas$date))))+31), "month"), 
...
g <- 
    ...
    scale_x_date(
        date_labels = "%b %y",
        breaks = seq.Date(from = floor_date(as.Date("2015-01-01")+(((month(max(df_06_01_farmaceuticos$date))))+31), "month"), 
...
g <- 
    ...
    scale_x_date(
        date_labels = "%b %y",
        breaks = seq.Date(from = floor_date(as.Date("2015-01-01")+(((month(max(df_06_02_servicios_pacientes$date))))+31), "month"), 
...
g <- 
    ...
    scale_x_date(
        date_labels = "%b %y",
        breaks = seq.Date(from = floor_date(as.Date("2015-01-01")+(((month(max(df_06_03_servicios_hospital$date))))+31), "month"), 
...
g <- 
    ...
    scale_x_date(
        date_labels = "%b %y",
        breaks = seq.Date(from = floor_date(as.Date("2015-01-01")+(((month(max(df_fiesta$date))))+31), "month"), 
...
for(i in 1:4){
    ...
    g <- 
        ...
        scale_x_date(
            date_labels = "%b %y",
            breaks = seq.Date(from = floor_date(as.Date("2015-01-01")+(((month(max(d_04_pacic$date))))+31), "month"), 
